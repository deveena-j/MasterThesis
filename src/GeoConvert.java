...
public class GeoConvert {
    ...
    public static String toMGRS(double lat, double lon) throws Exception {
        ...
        //return zone + band + " " + northing + " " + easting + x.substring(1,6) + " " + y.substring(2,7);
        return zone + band +  x.substring(1,6) + " "+ y.substring(2,7);
    }
